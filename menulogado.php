		...
		<div class="container">
			<div class="row">
                ...
                <li style="margin-left:-20%;"><a href="faleconosco.php">Suporte</a><br></li>
						...
						<nav class="main_nav">
							<ul class="d-flex flex-row align-items-center justify-content-start">
                <li style="min-width:70%;margin-right:5%;margin-left:10%;color:#FFFFFF;"><a>Procurar Players</a><br><a style="text-align:right;font-size:100%;" href="filtrodejogadoreslol.php">LOL</a> | <a style="text-align:left;font-size:100%;" href="csgo.php">CSGO</a></li>
								<li style="min-width:70%;color:#FFFFFF;"><a>Procurar Times</a><br><a style="text-align:right;font-size:100%;" href="filtroequipeslol.php">LOL</a> | <a style="text-align:left;font-size:100%;" href="csgo.php">CSGO</a></li>
							</ul>
						</nav>
					<nav class="main_nav">
						<ul class="d-flex flex-row align-items-center justify-content-start">
